...
import { DiamondGeometryParameters } from 'webgi/extras/ijewel/utils';
...
export declare class CubeNormalsCaptureHelper implements IDisposable {
    ...
    private _getPrecisionType;
    captureNormalMap(geometry: BufferGeometry, cacheKey?: string, size?: number, normalMapPrecision?: DiamondGeometryParameters['normalMapPrecision'], mesh?: Mesh): boolean;
    removeNormalMap(geometry: BufferGeometry): void;
}
