 ...
 * @returns {any}
 */
export declare function deserializeObject<T>(data: any, object: T, isThis: boolean, meta?: Record<string, any>): T;
 ...
 * @param name
 */
export declare function serializeTextureInExtras(texture: {
    uuid: string;
    userData: any;
    type: string;
    source?: any;
    name?: string;
}, meta: any, name?: string, mime?: string): {
    uuid: string;
    url: any;
    userData: any;
    type: string;
