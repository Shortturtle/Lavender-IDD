...
export declare class PresetGroup {
    ...
    addPresets(presets: TPreset[]): void;
    clear(): void;
...
export declare class ModelStagePresetGroup extends PresetGroup {
    name: string;
    apply(viewer: ViewerApp, preset: TPreset): Promise<any>;
}
...
export declare class VJSONPresetGroup extends PresetGroup {
    ...
    usePresetLoadingPlugin: boolean;
    usePresetInteractionPlugin: boolean;
    usePresetParallaxMappingPlugin: boolean;
    usePresetRendererUiPlugin: boolean;
    usePresetCameraViewPlugin: boolean;
    usePresetMaterialConfiguratorPlugin: boolean;
    usePresetSwitchNodePlugin: boolean;
