...
import { AddModelOptions, ICamera, ILight, IModel, IScene, ISceneEventMap, ISceneObject, ITexture, IWidget } from 'webgi/interfaces';
...
export declare class RootScene<TCamera extends CameraController = CameraController> extends Scene<ISceneEventMap> implements IScene<Scene, TCamera, ISceneEventMap> {
    isRootScene: boolean;
    assetType: 'model';
     ...
     * @returns {T}
     */
    addSceneObject<T extends ISceneObject = ISceneObject>(imported: T, options?: AddObjectOptions & AddModelOptions & {
        allImported?: any;
    }): T;
     ...
     */
    textureSlots: Record<string, Texture>;
     ...
     */
    setBackground(asset: ITexture | string | number | Color | null | 'environment'): void;
    /**
     ...
     * @param options - set sceneUpdate to true to mark that any object transformations have changed. It might trigger effects like frame fade depening on plugins.
     * @returns {this}
     */
    setDirty(options?: {
        sceneUpdate?: boolean;
