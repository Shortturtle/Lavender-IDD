import { ColorSpace, IUniform, Vector2, WebGLMultipleRenderTargets, WebGLRenderer, WebGLRenderTarget, WebGLRenderTargetOptions } from 'three';
...
export declare class BaseRenderer extends SimpleEventDispatcher<'animationLoop' | 'update' | 'resize' | 'contextLost' | 'contextRestored'> implements IRenderer {
    ...
    constructor({ animationLoop, canvas, alpha, targetOptions, maxHDRIntensity, }: {
    ...
    createTarget({ sizeMultiplier, samples, colorSpace, type, format, depthBuffer, depthTexture, depthTextureType, depthTextureFormat, size, textureCount, ...op }?: CreateRenderTargetOptions, trackTarget?: boolean): IRenderTarget;
    ...
    renderTargetToDataUrl(target: WebGLMultipleRenderTargets | WebGLRenderTarget, mimeType?: string, quality?: number, textureIndex?: number): string;
    renderTargetToBuffer(target: WebGLMultipleRenderTargets | WebGLRenderTarget, textureIndex?: number): Uint8Array | Uint16Array;
    /**
    ...
    /**
     * @deprecated use {@link stableNoise} instead
     */
