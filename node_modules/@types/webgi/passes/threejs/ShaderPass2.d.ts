...
import { IMaterial, IMaterialEventMap, IPass, IShaderPropertiesUpdater } from 'webgi/interfaces';
...
export declare abstract class AShaderMaterial2<TE extends IMaterialEventMap = IMaterialEventMap> extends ShaderMaterial<TE & IMaterialEventMap> implements IMaterial<ShaderMaterial<TE>, TE> {
