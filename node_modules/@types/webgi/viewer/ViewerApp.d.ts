import { AnyOptions, Class, IEvent, IEventDispatcher, IJSONSerializable, SimpleEventDispatcher } from 'ts-browser-helpers';
import { ICamera, ICameraOptions, IFilter, IMaterial, IModel, IRenderer, ISceneObject, ITexture, IViewerPlugin, IViewerPluginSync, ViewerState } from 'webgi/interfaces';
...
import { CanvasTexture, Color, Material, MeshPhysicalMaterialParameters, Object3D, OrthographicCamera, PerspectiveCamera, Texture } from 'three';
...
interface IViewerApp extends IEventDispatcher<'update' | 'preRender' | 'postRender' | 'preFrame' | 'postFrame' | 'dispose' | 'addPlugin' | 'renderEnabled' | 'renderDisabled'>, IJSONSerializable {
    state: ViewerState;
    renderer: IRenderer;
    scene: RootScene;
...
export declare class ViewerApp extends SimpleEventDispatcher<'update' | 'preRender' | 'postRender' | 'preFrame' | 'postFrame' | 'dispose' | 'addPlugin' | 'renderEnabled' | 'renderDisabled'> implements IViewerApp {
    static readonly VERSION = "0.11.1";
    console: Console;
    private _canvas;
    private _container;
    private _state;
    ...
    screenShader, maxHDRIntensity, ...options }: IViewerAppOptions);
    private _lastSize;
    ...
    /**
     * Number of times to run composer render.
     * Used in WebVR plugin.
     */
    ...
    doOnce<TRet>(event: 'postFrame' | 'preFrame' | 'preRender' | 'postRender' | 'renderEnabled' | 'renderDisabled', func?: (...args: any[]) => TRet): Promise<TRet | undefined>;
     ...
     * @param object
     */
    createObject3D(object?: Object3D, addToRoot?: boolean): Promise<Object3DModel | undefined>;
    /**
     ...
     * @returns {this}
     */
    deserializePlugins(plugins: any[], meta?: Record<string, any>): this;
    /**
     ...
     * @param data - The serialized JSON object returned from {@see toJSON}.
     * @param meta - The meta object
     * @returns {this}
     */
    fromJSON(data: any, meta?: Record<string, any>): this;
