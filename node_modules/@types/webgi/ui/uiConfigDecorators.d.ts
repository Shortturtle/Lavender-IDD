...
import { AnyOptions, ValOrFunc } from 'ts-browser-helpers';
...
export declare function uiDropdown(label?: string, children?: ValOrFunc<UiObjectConfig[]>, params?: (any | ((that: any) => any))): PropertyDecorator;
...
export declare function generateUiFolder(label: string, obj: any, params?: any, type?: string, dynamic?: boolean): UiObjectConfig;
...
export declare function valueToUiType(val: any): "number" | "checkbox" | "input" | "folder" | "button" | "color" | "vec" | "image" | null;
