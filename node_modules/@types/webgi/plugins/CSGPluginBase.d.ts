...
export type TCSGOperation = 'union' | 'subtract' | 'intersect';
...
export declare abstract class CSGPluginBase extends AViewerPlugin<''> {
    ...
    rootMesh: Mesh<import("three").BufferGeometry<import("three").NormalBufferAttributes, import("three").BufferGeometryEventMap>, import("three").Material<import("three").MaterialEventMap> | import("three").Material<import("three").MaterialEventMap>[], import("three").Object3DEventMap>;
