...
import { IEvent, IModel, IViewerPlugin, IViewerPluginAsync, UiObjectConfig } from 'webgi/interfaces';
...
export declare class BaseGroundPlugin<TMesh extends Mesh<BufferGeometry, MeshStandardMaterial> | Reflector2 = Mesh<BufferGeometry, MeshStandardMaterial> | Reflector2, TEvent extends string = ''> extends AViewerPlugin<TEvent> implements IViewerPluginAsync {
    get enabled(): boolean;
    ...
    set autoAdjustTransform(value: boolean);
