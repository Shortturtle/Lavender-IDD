...
export declare class CameraView implements IUiConfigContainer {
    ...
    deleteView: () => void;
    updateView: () => void;
    constructor(position?: Vector3, target?: Vector3, up?: Vector3, quaternion?: Quaternion, duration?: number);
 ...
 */
export declare class CameraViewPlugin extends AViewerPlugin<'viewChange' | 'startViewChange' | 'viewAdd' | 'viewDelete'> {
    ...
    splineCurve: 'centripetal' | 'chordal' | 'catmullrom';
    ...
    recordAllViews(onStart?: () => void, downloadOnEnd?: boolean): Promise<Blob | undefined>;
    addCurrentView(): Promise<void>;
    addView(view: CameraView): void;
    getCurrentCameraView(camera?: CameraController, worldSpace?: boolean, view?: CameraView): CameraView;
    ...
    animateToView(view: CameraView, duration?: number, easing?: Easing | EasingFunctionType, throwOnStop?: boolean): Promise<void>;
