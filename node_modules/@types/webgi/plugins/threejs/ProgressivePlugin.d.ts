import { ICamera, IFilter, IRenderTarget, IViewerPluginAsync, UiObjectConfig } from 'webgi/interfaces';
...
export declare class ProgressivePlugin extends MultiFilterPlugin<'', [IFilter<AddBlendPass, 'progressive'>]> implements IViewerPluginAsync {
    ...
    trackedJitterCameras: Set<[OrthographicCamera<import("three").Object3DEventMap> | PerspectiveCamera<import("three").Object3DEventMap>, {
        width: number;
        height: number;
    }]>;
    ...
    getLastFrame(camera?: ICamera): IRenderTarget | undefined;
