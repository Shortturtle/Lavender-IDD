...
import { IMaterial, ITexture, IViewerPluginAsync } from 'webgi/interfaces';
...
export declare class CustomBumpMapPlugin extends AViewerPlugin<''> implements IViewerPluginAsync {
