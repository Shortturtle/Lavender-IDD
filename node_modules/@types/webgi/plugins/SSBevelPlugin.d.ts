import { IGBufferUpdater, IRenderTarget, IViewerPluginAsync, UiObjectConfig } from 'webgi/interfaces';
...
export declare class SSBevelPlugin extends GenericFilterPlugin<SSBevelPass, 'ssBevel', ''> implements IViewerPluginAsync, IGBufferUpdater {
    passId: 'ssBevel';
