import { IGBufferUpdater, IMaterial, IViewerPluginAsync, UiObjectConfig } from 'webgi/interfaces';
...
export declare class BloomPlugin extends GenericFilterPlugin<BloomPass, 'bloom', ''> implements IViewerPluginAsync, IGBufferUpdater {
    ...
    setDirty(): void;
    protected _getUiConfig(material: IMaterial): UiObjectConfig<any, string>;
