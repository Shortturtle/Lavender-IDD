import { IFilter, IViewerPluginAsync, UiObjectConfig } from 'webgi/interfaces';
...
export declare class SSGIPlugin extends MultiFilterPlugin<'', [IFilter<SSRTAOPass, 'ssrtgi'>]> implements IViewerPluginAsync {
    private _progressive;
    private _manager;
    get rtgiTarget(): WebGLRenderTarget | undefined;
