...
import { IFilter, IPass, IViewerPluginAsync, UiObjectConfig } from 'webgi/interfaces';
...
export declare class SSRTAOPlugin extends MultiFilterPlugin<'', [IFilter<IPass, 'ssrtao'>]> implements IViewerPluginAsync {
    dependencies: (typeof AssetManagerPlugin | typeof GBufferPlugin)[];
    get rtaoTarget(): WebGLRenderTarget | undefined;
