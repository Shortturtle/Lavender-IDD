import { IFilter, IRenderTarget, IViewerPluginAsync, UiObjectConfig } from 'webgi/interfaces';
...
export declare class SSAOPlugin extends MultiFilterPlugin<'', [IFilter<SSAOPass, 'ssao'>]> implements IViewerPluginAsync {
