...
export declare class NormalBufferPlugin extends GenericFilterPlugin<NormalRenderPass, 'normalBuffer', ''> implements IViewerPluginAsync, IShaderPropertiesUpdater {
    passId: 'normalBuffer';
