...
export declare class VariationConfiguratorPlugin extends AViewerPlugin<''> {
    ...
    protected _loadMaterial(path: string, blob?: IFile): Promise<IMaterial<any, import("webgi/interfaces").IMaterialEventMap> | undefined>;
    protected _loadObject(path: string, blob?: IFile): Promise<IModel<Object3D<import("three").Object3DEventMap>, import("webgi/interfaces").IObject3DEventMap>[]>;
