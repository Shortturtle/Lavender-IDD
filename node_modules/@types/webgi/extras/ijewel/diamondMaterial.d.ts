import { BufferGeometry, Camera, Color, Matrix4, Object3D, Scene, Shader, ShaderMaterial, Texture, Vector3, WebGLRenderer } from 'three';
import { IMaterial, IMaterialEventMap, ITexture, UiObjectConfig } from 'webgi/interfaces';
...
export declare class DiamondMaterial extends ShaderMaterial<IMaterialEventMap> implements IMaterial {
