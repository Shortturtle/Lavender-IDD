...
import { BaseIJewel3DKeyPlugin } from 'webgi/extras/license/plugin';
export declare class DiamondPlugin extends BaseIJewel3DKeyPlugin<''> {
    ...
    envMap2: ITexture | null;
    envMap3: ITexture | null;
    forceSceneEnvMap: boolean;
    get envMapRotation(): number;
    set envMapRotation(value: number);
    getEnvMaps: () => (ITexture<any> | null)[] | (import("three").Texture<import("three").TextureEventMap> | null)[];
    refreshEnvMaps(): void;
    constructor();
    ...
    unprepareDiamondMesh(mesh: Mesh): void;
    prepareDiamondMesh(mesh: Mesh, { cacheKey, normalMapRes, normalMapPrecision }: DiamondGeometryParameters): void;
    /**
    ...
    private _removeOffsets;
    getAllCacheMaps(): unknown[];
    disposeCacheMap(cacheKey: string): void;
