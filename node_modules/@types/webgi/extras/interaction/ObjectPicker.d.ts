...
export declare class ObjectPicker extends SimpleEventDispatcher<'hoverObjectChanged' | 'selectedObjectChanged' | 'hitObject'> {
    ...
    addPasses(): void;
    checkIntersection(): {
        selectedObject: Object3D<import("three").Object3DEventMap>;
        intersect: Intersection<Object3D<import("three").Object3DEventMap>>;
        intersects: Intersection<Object3D<import("three").Object3DEventMap>>[];
