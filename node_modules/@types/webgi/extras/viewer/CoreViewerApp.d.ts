 ...
 * @example
 * ```
 * const viewer = new CoreViewerApp({canvas: document.getElementById('mcanvas'), licenseKey: 'MY_IJEWEL_KEY'})
...
export declare class CoreViewerApp extends ViewerApp {
    ...
    constructor(options: IViewerAppOptions & {
        /**
         * License key for using the DiamondPlugin
         */
        licenseKey?: string;
    });
    initialize({ caching, ground, bloom, depthTonemap, enableDrop, importPopup, debug, interactionPrompt }?: {
        ...
        interactionPrompt?: boolean | undefined;
    }): Promise<this>;
}
export declare function addBasePlugins(viewer: ViewerApp, { ground, bloom, depthTonemap, enableDrop, importPopup, interactionPrompt }?: {
    ground?: boolean | undefined;
    bloom?: boolean | undefined;
    depthTonemap?: boolean | undefined;
    enableDrop?: boolean | undefined;
