...
import { BufferGeometry, Material, MeshStandardMaterial, Object3D, Texture } from 'three';
export declare class GLTFWriter2 extends GLTFExporter.Utils.GLTFWriter {
    ...
    processImage(image: any, format: number, flipY: boolean, mimeType?: string): number;
    /**
