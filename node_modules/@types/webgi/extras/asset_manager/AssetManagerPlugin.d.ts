...
import { AddModelOptions, ISceneObject, IViewerPlugin, IViewerPluginSync } from 'webgi/interfaces';
...
export type ImportAddOptions = ImportAssetOptions & AddModelOptions & AddObjectOptions;
export type AddImportedOptions = ProcessImportedOptions & AddObjectOptions & AddModelOptions;
export declare class AssetManagerPlugin extends SimpleEventDispatcher<''> implements IAssetManager, IViewerPluginSync {
    ...
    importPluginPreset(json: any, plugin?: IViewerPlugin): Promise<IViewerPlugin<boolean> | undefined>;
