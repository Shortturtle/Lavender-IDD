import { BufferGeometry, Camera, IUniform, Material, MeshBasicMaterial, MeshPhysicalMaterialParameters, Object3D, Scene, Shader, WebGLRenderer } from 'three';
...
export declare class MeshBasicMaterial2<TE extends IMaterialEventMap = IMaterialEventMap> extends MeshBasicMaterial<TE & IMaterialEventMap> implements IMaterial<MeshBasicMaterial<TE>, TE> {
