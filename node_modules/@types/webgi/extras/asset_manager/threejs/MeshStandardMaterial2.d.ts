import { BufferGeometry, Camera, Color, IUniform, Material, MeshPhysicalMaterial, MeshPhysicalMaterialParameters, Object3D, Scene, Shader, Vector2, WebGLRenderer } from 'three';
import { MaterialExtension } from './MaterialExtender';
import { IMaterial, IMaterialEventMap, UiObjectConfig } from 'webgi/interfaces';
...
export declare class MeshStandardMaterial2<TE extends IMaterialEventMap = IMaterialEventMap> extends MeshPhysicalMaterial<TE & IMaterialEventMap> implements IMaterial<MeshPhysicalMaterial<TE>, TE> {
    ...
    copyProps(oldMaterial: Material, allowUnknownType?: boolean, clearCurrentUserData?: boolean): this;
    toJSON(meta?: any): any;
